...
class APOTfLearner(APOLearner, TfLearner):
    """Implements tf-specific APO loss logic on top of APOLearner.
    ...
    def compute_loss_for_module(
        ...
        *,
        ...
        if hps.use_critic:
            ...
            vf_loss = 0.5*tf.math.square(value_fn_out - batch[Postprocessing.VALUE_TARGETS])
        ...
        print("average reward apo_tf_learner: ",self.average_reward_estimate)
