...
class APOCatalog(Catalog):
    """The Catalog class used to build models for APO.

    APOCatalog provides the following models:
    ...
    for the policy and value function. See implementations of APORLModule for
    more details.
    ...
    def build_encoder(self, framework: str) -> Encoder:
        ...
        raise NotImplementedError(
            "Use APOCatalog.build_actor_critic_encoder() instead for APO."
        )
