...
class APOTorchLearner(APOLearner, TorchLearner):
    """Implements torch-specific APO loss logic on top of APOLearner.
    ...
    def compute_loss_for_module(
        ...
        *,
        ...
        if hps.use_critic:
            vf_targets_bias_control = batch[Postprocessing.VALUE_TARGETS] - hps.bias_factor * hps.bias_estimate
            value_fn_out = fwd_out[SampleBatch.VF_PREDS]
		
            vf_loss = 0.5 * torch.pow(value_fn_out - vf_targets_bias_control, 2.0)
