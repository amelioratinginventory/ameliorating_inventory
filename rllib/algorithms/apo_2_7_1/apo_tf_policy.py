...
def get_apo_tf_policy(name: str, base: TFPolicyV2Type) -> TFPolicyV2Type:
    """Construct an APOTFPolicy inheriting either dynamic or eager base policies.
    ...
    class APOTFPolicy(
        ...
        def __init__(
            ...
            self.average_reward_estimate = np.mean([config["init_average_reward_estimate"]])
            ...
            #self.view_requirements[SampleBatch.INFOS] = ViewRequirement(SampleBatch.INFOS)
        ...
        def loss(
            ...
            print("average reward apo_tf_policy: ",self.average_reward_estimate)
