...
class PPOConfig(PGConfig):
    ...
    def __init__(self, algo_class=None):
        ...
        # Allow discarding samples in infinite horizon mode.
        self.truncation_length = 300
        assert self.truncation_length < self.train_batch_size/self.num_rollout_workers, (
            "Truncation length must be smaller than train batch size"
            " (to allow for proper GAE estimation)."
        )
