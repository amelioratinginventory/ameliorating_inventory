...
from ray.rllib.algorithms.aro_ddpg.aro_ddpg_tf_model import ARO_DDPGTFModel
from ray.rllib.algorithms.aro_ddpg.aro_ddpg_torch_model import ARO_DDPGTorchModel
from ray.rllib.algorithms.aro_ddpg.noop_model import NoopModel, TorchNoopModel
from ray.rllib.models import ModelV2
from ray.rllib.models.catalog import ModelCatalog
from ray.rllib.utils.error import UnsupportedSpaceException


def make_aro_ddpg_models(policy: Policy) -> ModelV2:
    ...
    model = ModelCatalog.get_model_v2(
        ...
        model_interface=(
            ARO_DDPGTorchModel if policy.config["framework"] == "torch" else ARO_DDPGTFModel
        ),
