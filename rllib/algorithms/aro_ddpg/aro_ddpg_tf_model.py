...
class ARO_DDPGTFModel(TFModelV2):
    """Extension of standard TFModel to provide ARO_DDPG action- and q-outputs.
    ...
    def __init__(
        ...
        Extra model kwargs:
            actor_hiddens: Defines size of hidden layers for the ARO-DDPG
                policy head.
                These will be used to postprocess the model output for the
                purposes of computing deterministic actions.

        Note that the core layers for forward() are not defined here, this
        only defines the layers for the ARO-DDPG head. Those layers for forward()
        should be defined in subclasses of ARO-DDPGActionModel.
        """
        ...
        super(ARO_DDPGTFModel, self).__init__(
